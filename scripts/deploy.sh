...
echo ""
echo "📡 WiFi Troubleshooting Commands:"
echo "  Check hardware: sudo ./scripts/check_wifi_hardware.sh"
echo "  Fix AP issues: sudo ./scripts/fix_wifi_ap.sh"
echo "  Start AP mode: sudo ./scripts/darkhelmet-ap-mode-improved.sh"
echo ""
echo "If SSID not visible, try:"
echo "  ssh $PI_USER@$PI_IP 'sudo ./dark_helmet/scripts/fix_wifi_ap.sh'"